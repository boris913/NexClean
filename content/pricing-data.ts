...
export const pricingParticuliers: PricingOption[] = [
  {
    ...
    features: ['Nettoyage complet', 'Sols et surfaces', 'Sanitaires', '1 heure d\'intervention'],
  },
  {
    id: '1-chambre-salon',
    ...
    features: ['Nettoyage complet', 'Toutes les pièces', 'Cuisine et sanitaires', '1h30 d\'intervention'],
    popular: true,
  },
  {
    id: '2-chambres-salon',
    ...
    features: ['Nettoyage complet', 'Grande maison', 'Toutes les surfaces', '2 heures d\'intervention'],
    popular: true,
  },
  {
    id: '3-chambres-salon',
    ...
    features: ['Nettoyage complet', 'Espaces extérieurs', 'Plusieurs étages', 'Sur devis personnalisé'],
  },
];
...
export const pricingProfessionnels: PricingOption[] = [
  {
    ...
    priceAbonnement: '50 000 FCFA/mois',
    features: ['2 passages/semaine', 'Espaces de travail', 'Sanitaires', 'Désinfection incluse'],
  },
  {
    id: 'bureau-moyen',
    name: 'Bureau Moyen',
    ...
    features: ['2 passages/semaine', 'Plusieurs bureaux', 'Salle de réunion', 'Désinfection renforcée'],
    popular: true,
  },
  {
    id: 'commerce',
    ...
    features: ['Planning flexible', 'Vitrine incluse', 'Zone client', 'Intervention rapide'],
    popular: true,
  },
  {
    id: 'grande-structure',
    ...
    features: ['Solution personnalisée', 'Équipe dédiée', 'Plusieurs passages/semaine', 'Contrat sur mesure'],
  },
];
