...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: "Espace de travail professionnel et sain pour vos équipes. Nettoyage adapté aux bureaux et commerces.",
  ...
  },
  {
    ...
    description: "Remise en état après construction ou rénovation. Élimination complète de la poussière et débris.",
...
export const getServicesByCategory = (category: 'particulier' | 'professionnel') => {
